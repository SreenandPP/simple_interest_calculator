  ...
  return (
    ...
    <div className='w-100 bg-dark d-flex justify-content-center align-items-center' style={{height : '100vh'}}>
           <div className='bg-light w-50 shadow rounded p-5' >
             ...
             <div className='d-flex justify-content-center p-5 border shadow mt-3 ' style={{backgroundColor:'#869cfc'}}>
             ₹{result}
             </div>
             ...
             <form onSubmit={(e)=>{submitted(e)}}>
                ...
                <Button disabled={validpamount&&validrate&&validtime?false:true} variant="contained" type='submit' className='bg-dark ' style={{height:'50px',width:'100%'}}>SUBMIT</Button>
                <Button variant="contained" type='reset' onClick={resetForm} className='bg-info' style={{height:'50px',width:'100%'}}>RESET</Button>
                </Stack>
             </form>
           </div>
    </div>
